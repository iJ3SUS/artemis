    ...
    <Page>
        <template #heading>
            <Heading>
                ...
                <template #actions>
                    <Button color="primary" v-can="'users.create'" @handle="router.push('/users/create')">
                ...
                <template v-if="users">
                    ...
                    <Column>
                        <div class="flex items-center justify-center gap-2">
                            <Button theme="icon" v-can="'users.update'" v-tooltip:left="'Editar'" @handle="router.push(`/users/${user._id}/edit`)">
                                <Icon icon="Pencil" width="16" height="16" class="text-inherit" />
                            </Button>
                            <Button theme="icon" v-can="'users.password'" v-tooltip:left="'Cambiar contraseña'" @handle="current.user = user; modals.password = true">
