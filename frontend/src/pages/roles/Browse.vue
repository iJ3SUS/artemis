    ...
    <Page>
        <template #heading>
            <Heading :sticky="true">
                ...
                <template #actions>
                    <Button color="primary" v-can="'roles.create'" @handle="router.push('/roles/create')">
                ...
                <template v-if="roles">
                    ...
                    <Column>
                        <div class="flex items-center justify-center gap-2">
                            <Button theme="icon" v-can="'roles.update'" v-tooltip:left="'Editar'" @handle="router.push(`/roles/${role._id}/edit`)">
