    ...
    <Page>
        <template #heading>
            <Heading :sticky="true">
                ...
                <template #actions>
                    <Button color="primary" v-can="'job-titles.create'" @handle="router.push('/job-titles/create')">
                ...
                <template v-if="jobTitles">
                    ...
                    <Column>
                        <div class="flex items-center justify-center gap-2">
                            <Button theme="icon" v-can="'job-titles.update'" v-tooltip:left="'Editar'" @handle="router.push(`/job-titles/${jt._id}/edit`)">
