            ...
            <Heading :sticky="true">
                ...
                <template #title>
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-0.5">Agrega un nuevo cargo laboral</p>
                    </div>
                </template>
                <template #actions>
                    <Button v-if="$can('job-titles.create')" color="primary" @handle="create" :disabled="!http.loading">Guardar</Button>
                </template>
            </Heading>
        </template>
