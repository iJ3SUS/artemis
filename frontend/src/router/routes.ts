...
export const routes = [
    ...
    { path: '/job-titles', label: 'Cargos laborales', icon: 'Briefcase', component: JobTitles, meta: { protected: true, section: 'management', order: 3 } },
    ...
    { path: '/users', label: 'Usuarios', icon: 'UserShare', component: Users, meta: { protected: true, section: 'management', order: 4 } },
    ...
    { path: '/roles', label: 'Roles', icon: 'ID', component: Roles, meta: { protected: true, section: 'management', order: 5 } },
    ...
    { path: '/disabilities', label: 'Incapacidades', icon: 'ExclamationCircle', component: Disabilities, meta: { protected: true, section: 'management', order: 2 } },
