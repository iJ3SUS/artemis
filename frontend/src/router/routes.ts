...
export const routes = [
    ...
    { path: '/employees', label: 'Empleados', icon: 'AccountGroup', component: Employees, meta: { protected: true, section: 'management', order: 1 } },
    ...
    { path: '/users', label: 'Usuarios', icon: 'Account', component: Users, meta: { protected: true, section: 'management', order: 3 } },
    ...
    { path: '/roles', label: 'Roles', icon: 'ShieldAccount', component: Roles, meta: { protected: true, section: 'management', order: 4 } },
